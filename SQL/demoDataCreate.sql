...
VALUES('北區淨灘團', 1, '2020/4/16', '活動地區以北北基為主，開放大家投票討論下一次淨灘地點～', ''),
	...
	('福爾摩沙原生植物與他們的守護者們', 1, '2020/08/18', '我們以實際的行動參與且推動一切有關台灣原生植物的保育工作，致力於教導民眾自然保育的觀念，防止自然原生環境盜採濫墾的發生...', 'community/rrc01.jpg'),
	('外來種狩獵場', 2, '2020/08/01', '守護台灣原生種，加入我們獲得有關外來種的資訊，協助我們一同移除外來種。', 'community/rrc02.jpg');
...
values('2020國家地理路跑-世界地球日50週年', '2020/03/09', '2020/08/09 12:00', '2020/08/09 14:00:00' , 4, 'https://www.eventpal.com.tw/FOAS/actions/ActivityIndex.action?showTabContent&seqno=9db4bc32-d8ef-473f-8bcd-e17840edab64',
	...
	('創意手作乾燥花體驗', '2020-08-06', '2020-09-20 14:00', '2020-09-20 18:00', 19, '幸福的真正秘密，就在於，對於日常生活的所有細節抱著純粹的興趣。- William Morris 威廉莫里斯 今天你想怎樣度過呢？你的日常又充滿著什麼樣的細節呢？讓我們放下平日的繁瑣體驗一花一草的細膩美好吧',
		'activity/08.jpg', 0, 10, 1, 3, '台北', 25.034404, 121.565000),
