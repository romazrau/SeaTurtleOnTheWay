...
values ('潛水'), ('世界地球日'), ('淨街'), ('環保'),('阿里山'),('雲端'),('2020'),('路跑'),('停一下往山林'),
       ('斯巴達'),('障礙賽'),('普悠瑪'),('鐵人三項'),('黃明志'),('虛擬演唱會'),('AR'),('好想出去走'),('高雄'),
	   ('淨灘'),('健行'),('金山'),('淨海'),('一件好事'),('Discovery'),('衫林溪'),('擁抱大自然'),('貓咪照顧'),
	   ('關懷流浪動物'),('銀髮族'),('公館'),('跳蚤市集'),('舊衣'),('偏鄉教育'),('研習營'),('教育'),('共勉之'),
	   ('浪浪'),('義賣'),('領養代替購買'), ('刺青'),('剪髮'),('瑜珈'),('公益'),('初學者友善'),('周末活動'),
	   ('古物'),('野柳'), ('環境保護'),('師大夜市'),('就缺你一個');
