...
namespace backe.Controllers
{
    public class AccountController : Controller
    {
        ...
        public JsonResult Login(accountLogin obj)
        {
            ...
            Session[ClsKeySession.login_member_Entity_obj] = me;
        ...
        {
            tMember me = Session[ClsKeySession.login_member_Entity_obj] as tMember;
            if (me == null)
            {
        ...
        {
            Session.Remove(ClsKeySession.login_member_Entity_obj);
            tMember me = Session[ClsKeySession.login_member_Entity_obj] as tMember;
            if (me == null)
            {
